...
function Home() {
  ...
  return (
    ...
    <div className='flex justify-center mb-6'>
      ...
      ${index === 2 ? "rotate-[-3deg]" : ""}
    `}>
      <div className='absolute -top-8 left-1/2 -translate-x-1/2 bg-white border-2 border-green-500 text-green-600
          ...
          [
            {
            ...
            },
             {
              ...
              desc: "Detailed strenghs, weaknesses and imporvemen insights."
            },
             {
              image: analyticsImg,
              icon: <BsBarChart size={20}/>,
          ...
          [
            {
            ...
            },
             {
              ...
              desc: "Basic tone an voice analysis insights."
            },
             {
              image: creditImg,
