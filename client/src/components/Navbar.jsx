...
function Navbar() {
  ...
  return (
    <div className='bg-[#f3f3f3] flex justify-center px-4 pt-6'>
      ...
      className='w-full max-w-6xl bg-white rounded-[24px] shadow-sm border border-gray-200 py-4 px-4 sm:px-6 lg:px-8 flex justify-between items-center relative'>
