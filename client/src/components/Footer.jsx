...
function Footer() {
  return (
    <div className='bg-[#f3f3f3] flex justify-center px-4 pb-10 py-4 pt-10'>
      ...
      AI-powered interview preparation platform design to imporve communication skills, technical depth and professinal confidence.
      </p>
      {/* Copyright */}
<div className='mt-6 border-t border-gray-200 pt-4'>
  <p className='text-xs text-gray-500'>
    © 2026 MockMate AI. All rights reserved. Designed & developed by Sahil Dubey.
  </p>
</div>
      </div>
    </div>
