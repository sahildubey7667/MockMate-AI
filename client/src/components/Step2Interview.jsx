   ...
   if(!selectedVoice){
    ...
    const runIntro = async ()=>{
      if(isIntroPhase){
       ...
       await speakText(
        "I'll ask you a few questions. Just answer naturally, and take yourtime. Lets begin."
       ); 
...
useEffect(() => {
  ...
  return (
    <div className='min-h-screen bg-gradient-to-br from-emerald-50 via-white to-teal-100 flex items-center justify-center p-4 sm:p-6'>
      ...
      <div className='w-full max-w-300 min-h-[80vh] bg-white rounded-3xl shadow-2xl border border-gray-200 flex flex-col lg:flex-row overflow-hidden'>
     {/* video section */}
...
<textarea 
          ...
          {!feedback ? (<div className='flex items-center gap-4 mt-6'>
            ...
            to-teal-500 text-white py-3 sm:py-3 rounded-2xl shadow-lg
            hover:opacity-90 transtion font-semibold disabled:bg-gray-500'>
