      ...
      <div className='w-full max-w-6xl bg-white rounded-3xl shadow-2xl grid md:grid-cols-2 overflow-hidden'>
        ...
        <h2 className='text-4xl font-bold text-gray-800 mb-6'>
         ...
         <p className='text-gray-600 mb-10'>
          Practice real iterview scenarios powered by AI.
         ...
         className='p-12 bg-white'>
          ...
          <div className='space-y-6'>
            <div className='relative'>
             ...
             <input type='text' placeholder='Exprience (e.g. 2 years)'
             className='w-full pl-12 pr-4 py-3 border border-gray-200
             rounded-xl focus:ring-2 focus:ring-green-500 outline-none transition'
            ...
            <select value={mode} 
             ...
             whileHover={{scale: 1.03}}
             whileTap={{scale: 0.95}}
              className='w-full disabled:bg-gray-600 bg-green-600 hover:bg-green-700 text-white
